...
// Currently this just produces a summed total of the input events
...
module.exports.logCsv = phase({input: types.number, output: types.number, arity: '1:1'},
  function(data, tags) {
    for (tag in tags.tags) {
      console.log("jo")
      console.log(tag, tags.read(tag));
    }
    console.log("jojo: " + data + " " + data.tags);
    return data;
  });
